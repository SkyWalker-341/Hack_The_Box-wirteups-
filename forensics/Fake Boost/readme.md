...
Unzip the zip file archive the password is {hackthebox} then you got a network traffice file analyze the protocol by using wireshark sreach any http packages are there. 

![Screenshot from 2025-01-28 00-49-36](https://github.com/user-attachments/assets/a04ef95a-767a-4fe3-84af-3c2df0912ab4)

In the serach we got is strange paragraph of text in the bottom line it say 

---

```$jozeq3n.ToCharArray() ; [array]::Reverse($s0yAY2gmHVNFd7QZ) ; -join $s0yAY2gmHVNFd7QZ 2>&1> $null ;
...
```
### The powerscript say reverse strings of base64 encode data 

![Screenshot from 2025-01-28 00-48-44](https://github.com/user-attachments/assets/70d1cd84-3797-40c7-bb10-431233a5d35f)
...
*** After decode the base64 it will powerscript to steal dicord tokens 

![Screenshot from 2025-01-28 00-48-59](https://github.com/user-attachments/assets/e51b9147-42bd-449c-ae48-527464d4bdb4)
...
*** The tokens was encrypted by ase and the key contains in the script itself ```Y1dwaHJOVGs5d2dXWjkzdDE5amF5cW5sYUR1SWVGS2k=```

![Screenshot from 2025-01-28 01-40-53](https://github.com/user-attachments/assets/3b6787fb-3478-46c5-8d97-22c480676db0)


And the encrypted data stored in file named : {rj1893rj1joijdkajwda} extarct this file http protocol, The file contains : ```
...
make the decrypted script for the ase encode data 
```
import base64
from Crypto.Cipher import AES
from Crypto.Util.Padding import unpad
encrypted_data = "place the encoden data"
# AES key (decoded from Base64)
...
**In the email you will get another base64 strings :** {YjNXNHIzXzBmX1QwMF9nMDBkXzJfYjNfN3J1M18wZmYzcjV9} -> decoder : ```b3W4r3_0f_T00_g00d_2_b3_7ru3_0ff3r5}```

**other base64 strings you will in the encrypted script :** {SFRCe2ZyMzNfTjE3cjBHM25fM3hwMDUzZCFf} -> decoder : ```HTB{fr33_N17r0G3n_3xp053d!_```
